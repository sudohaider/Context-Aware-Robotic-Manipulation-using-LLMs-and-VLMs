...
public:
  ...
  {
    this->serviceClient_ = this->create_client<task_planner_interfaces::srv::PlanningAction>("planning_service");
...
private:
  ...
  rclcpp::Client<task_planner_interfaces::srv::PlanningAction>::SharedPtr serviceClient_;
